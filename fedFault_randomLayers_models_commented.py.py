...
# Track time spent on training and comms
...
def _add_timing(client_id, key, delta_s):
    """
    Update the timing dictionary for a specific client-metric combination
    """
...
# Contains training hyperparameters, network timeout settings
BATCH_SIZE = 32
EPOCHS_PER_ROUND = 1
THRESHOLD = 0.6
